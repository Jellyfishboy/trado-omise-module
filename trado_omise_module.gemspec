...
Gem::Specification.new do |s|
  ...
  s.summary     = "Module for Omise payment functionality in the Trado Ecommerce platform."
  s.description = "Module for Omise payment functionality in the Trado Ecommerce platform."
  s.license     = "MIT"
